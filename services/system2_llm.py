...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "casual — no un chatbot formal. El texto que te llega puede venir en "
    "inglés (el reconocimiento de voz corre en inglés) -- entendelo "
    "igual, pero respondé SIEMPRE en español, nunca en inglés. Reglas "
    "duras:\n"
